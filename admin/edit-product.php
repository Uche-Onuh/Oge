                            ...
                            <form action="code.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="slug" class="form-control mb-2" value="<?= $data['slug'] ?>" placeholder="Enter Product Slug" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label class="mb-0">Small Description</label>
                                        <textarea name="small_description" id="" cols="30" rows="5" placeholder="Enter Small Product Description" class="form-control mb-2"><?= $data['small_description'] ?></textarea>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="qty" class="form-control mb-2" value="<?= $data['qty'] ?>" placeholder="Enter Product Quantity">
                                        </div>
                                        <div class="col-md-3">
